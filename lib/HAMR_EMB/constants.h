...
#define LOOPTIME              1000.0                  // Desired speed of the main loop in microseconds used to 2700
...
#define MAX_M1_VEL            0.6//(110/60.0)*WHEEL_DIAMETER*3.1415*0.75         //Note 0.95  is used to estimate the motor's reduced speed due to load. 0.8777351
#define MAX_M2_VEL            0.6//(110/60.0)*WHEEL_DIAMETER*3.1415*0.75         //Note 0.95  is used to estimate the motor's reduced speed due to load 0.8777351

// Constant parameters for motor/ turret acceleration limits. Units are deg/s^2 and ms/^2
#define MAX_BASE_ACCEL        0.05
#define MAX_HOLO_ACCEL        0.15
